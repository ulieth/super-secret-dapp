    ...
    <div className="hero py-[64px]">
      <div className="hero-content text-center">
        <div className="max-w-2xl">
          {typeof title === 'string' ? <h1 className="text-5xl font-bold mb-2">{title}</h1> : title}
          {typeof subtitle === 'string' ? <p className="text-gray-700 text-xl mb-6">{subtitle}</p> : subtitle}
          {children}
        </div>
      </div>
    </div>
